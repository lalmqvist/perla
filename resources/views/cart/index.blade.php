					...
					@foreach ($cartItems as $item)
						<li class="list-group-item">
							<div class="row align-items-center justify-content-between">
								...
								<div class="col-md-2 icons text-right">
									<a href="/removefromcart/{{ $item->getHash() }}">t</a>
								</div>
...
@else
	<a class="nav-link" href="{{ route('login') }}">
		<button type="button" class="btn btn-primary btn-lg btn-block btn-cart">Fortsätt till checkout</button>
	</a>
@endauth
