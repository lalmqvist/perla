    ...
    <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample10">
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="/ads" id="dropdown1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">KATEGORIER</a>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">VÄLGÖRENHET</a>
