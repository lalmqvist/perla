    ...
    @foreach ($ads as $ad)
        <div class="card text-center">
          <a href="/ads/{{ $ad->id }}">
            ...
            <button id="wish-button" data-ad-id="{{ $ad->id }}" data-user-id="{{ Auth::user()->id }}" class="d-none wish-button-index btn btn-outline-primary"><span class="icons">e</span>  Spara favorit</button>  
            <button id="removewish" data-ad-id="{{ $ad->id }}" data-user-id="{{ Auth::user()->id }}" class="wish-button-index btn btn-outline-primary"><span class="icons">f</span>  Ta bort favorit</button>  
